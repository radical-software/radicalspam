...
"/addons/spamassassin/var/spamassassin".
...
sub new {
  ...
  $self->{PREFIX}		||= '/addons/spamassassin';
  $self->{DEF_RULES_DIR}	||= '/addons/spamassassin/share/spamassassin';
  $self->{LOCAL_RULES_DIR}	||= '/addons/spamassassin/etc';
  $self->{LOCAL_STATE_DIR}	||= '/addons/spamassassin/var/spamassassin';
