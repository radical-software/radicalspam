...
=item An official source of data
...
=item A free source of the data
...
=item code2currency( CODE [,CODESET] )
...
=item currency2code( NAME [,CODESET] )

=item script2code  ( NAME [,CODESET] )
...
=item language_code2code( CODE ,CODESET ,CODESET2 )

=item currency_code2code( CODE ,CODESET ,CODESET2 )

=item script_code2code  ( CODE ,CODESET ,CODESET2 )
...
=item all_currency_codes( [CODESET] )

=item all_script_codes  ( [CODESET] )
...
=item all_language_names( [CODESET] )

=item all_currency_names( [CODESET] )

=item all_script_names  ( [CODESET] )
...
=item Locale::Language::rename_language( CODE ,NEW_NAME [,CODESET] )

=item Locale::Currency::rename_currency( CODE ,NEW_NAME [,CODESET] )

=item Locale::Script::rename_script    ( CODE ,NEW_NAME [,CODESET] )
...
=item Locale::Language::add_language( CODE ,NAME [,CODESET] )

=item Locale::Currency::add_currency( CODE ,NAME [,CODESET] )

=item Locale::Script::add_script    ( CODE ,NAME [,CODESET] )
...
=item Locale::Language::delete_language( CODE [,CODESET] )

=item Locale::Currency::delete_currency( CODE [,CODESET] )

=item Locale::Script::delete_script    ( CODE [,CODESET] )
...
=item Locale::Language::add_language_alias( NAME ,NEW_NAME )

=item Locale::Currency::add_currency_alias( NAME ,NEW_NAME )

=item Locale::Script::add_script_alias    ( NAME ,NEW_NAME )
...
=item Locale::Language::delete_language_alias( NAME )

=item Locale::Currency::delete_currency_alias( NAME )

=item Locale::Script::delete_script_alias    ( NAME )
...
=item Locale::Language::rename_language_code( CODE ,NEW_CODE [,CODESET] )

=item Locale::Currency::rename_currency_code( CODE ,NEW_CODE [,CODESET] )

=item Locale::Script::rename_script_code    ( CODE ,NEW_CODE [,CODESET] )
...
=item Locale::Language::add_language_code_alias( CODE ,NEW_CODE [,CODESET] )

=item Locale::Currency::add_currency_code_alias( CODE ,NEW_CODE [,CODESET] )

=item Locale::Script::add_script_code_alias    ( CODE ,NEW_CODE [,CODESET] )
...
=item Locale::Language::delete_language_code_alias( CODE [,CODESET] )

=item Locale::Currency::delete_currency_code_alias( CODE [,CODESET] )

=item Locale::Script::delete_script_code_alias    ( CODE [,CODESET] )
